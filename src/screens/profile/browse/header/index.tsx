...
import {Button, Typography, AppBar, Tabs, Tab, Grid, Avatar,Box, IconButton} from '@mui/material'
          ...
          <Grid container item md={6}>
            <AppBar position="static" color="default" className={style.appbar}>
              ...
              >
                ...
                <Tab label={`Friends (${user.friends.accepted?.length})`} className={style.item} />
              </Tabs>
            </AppBar>
          </Grid>
        </Grid>
