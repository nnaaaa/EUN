      ...
      <Grid container>
        ...
        <Grid item container xs={12} style={{paddingTop: 10}}>
          <Button className={style.button}>
            ...
            <Typography className={style.textBtn} noWrap>Live Video</Typography>
          </Button>
          <Divider orientation="vertical" style={{margin: '0 10px'}} />
          <Button className={style.button}>
            <FontAwesomeIcon icon={faImages} color="#41B35D" />
            <Typography className={style.textBtn} noWrap>Photo/Video</Typography>
          </Button>
          <Divider orientation="vertical" style={{margin: '0 10px'}} />
          <Button className={style.button}>
            <FontAwesomeIcon icon={faSmile} color="#EAB026" />
            <Typography className={style.textBtn} noWrap>Feeling/Activity</Typography>
          </Button>
        </Grid>
      </Grid>
    </Box>
